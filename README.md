...
Now, we will actually start to run our simulation using the files provided [here](https://github.com/nicoleyshebbel/Molecular-Dynamics-workshop/tree/main/Simulation%20Files). You should download all of the files inside of that folder and put them inside of your working directory( the place where you will run the simulation).
