...
- `-p`: This flag will GROMACS to upload your topology file after running the current step.
...
```
gmx editconf -f 181L_cg.pdb -o 181L_cg.gro -d 1.0 -bt cubic -c
```
...
Your final top file should look like this: 
```
#include "martini.itp"
...
_Figure 5. And there you have it!_
